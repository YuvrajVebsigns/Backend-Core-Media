...
export class AuthController {
  ...
  @ApiStandardResponse({ status: 200, description: 'Login successful', type: LoginResponseDto })
  ...
  @ApiStandardResponse({ status: 200, description: 'OTP sent successfully (check console)', type: AuthMessageResponseDto })
  ...
  @ApiStandardResponse({ status: 200, description: 'OTP verified, returns resetToken', type: VerifyOtpResponseDto })
  ...
  @ApiStandardResponse({ status: 200, description: 'Password reset successfully', type: AuthMessageResponseDto })
  ...
  @ApiStandardResponse({ status: 200, description: 'Tokens refreshed', type: RefreshResponseDto })
