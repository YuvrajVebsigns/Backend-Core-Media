...
export class AdminCommunicationsController {
  ...
  @ApiOperation({
    summary:
      'Discover Mongoose database collections/relations and communication variables',
    description:
  ...
  @ApiResponse({
    status: 200,
    description: 'List of discoverable collections and fields',
  })
  ...
  @ApiOperation({
    summary:
      'Discover raw Mongoose database collections/relations for reference',
    description:
      'Returns raw Mongoose schema introspection data without communication variable mapping overlay.',
  })
  @ApiResponse({
    status: 200,
    description: 'List of raw Mongoose collections and fields',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 429, description: 'Rate limit exceeded' })
  ...
  @ApiOperation({
    ...
    description:
      'Returns paginated email/SMS/push communication logs. Filter by channel, status, or search by recipient/title.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiQuery({
    ...
    required: false,
    type: String,
    description: 'Search by recipient, title, or content',
  })
  @ApiQuery({
    name: 'channel',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Returns full details of a single communication log including delivery status, provider response, and metadata.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Manually fetches the latest delivery status from the email provider (e.g. Brevo) and updates the local log record.',
  })
  @ApiParam({
    name: 'id',
    description: 'MongoDB ID of the communication log to sync',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Dispatches a one-off email, SMS, or push notification to a single recipient. The message is queued via the configured provider.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Returns all registered communication providers (e.g. Brevo) along with their current active/inactive status and configuration.',
  })
  @ApiResponse({
    status: 200,
    description: 'List of all providers with statuses',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 429, description: 'Rate limit exceeded' })
  findAllProviders() {
  ...
  @ApiOperation({
    ...
    description:
      'Creates and configures a new email/SMS/push provider with API credentials and default sender settings.',
  })
  ...
  @ApiOperation({
    ...
    description:
      "Partially updates an existing provider's API credentials, sender configuration, priority, or active status.",
  })
  ...
  @ApiOperation({
    ...
    description:
      'Deletes the provider record and its credentials from the system.',
  })
  @ApiParam({ name: 'id', description: 'MongoDB ID of the provider' })
  ...
  @ApiOperation({
    ...
    description:
      "Performs a real-time health check against the provider's API to verify connectivity and authentication.",
  })
  @ApiParam({ name: 'name', description: 'Provider name (e.g. brevo)' })
  @ApiResponse({
    status: 200,
    description: 'Health check result with connected status',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 429, description: 'Rate limit exceeded' })
  ...
  @ApiOperation({
    ...
    description:
      'Returns paginated email/SMS templates. Filter by channel, active status, or search by name/slug.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Returns full template details including HTML content, variables, sender config, and Brevo sync status.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Creates a local email/SMS template record and automatically syncs it to the Brevo SMTP template library.',
  })
  @ApiResponse({
    status: 201,
    description: 'Template created and synced to Brevo',
  })
  @ApiResponse({ status: 400, description: 'Invalid request body' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 429, description: 'Rate limit exceeded' })
  ...
  @ApiOperation({
    ...
    description:
      'Partially updates a local template and syncs the changes to Brevo. Only provided fields are updated.',
  })
  @ApiParam({ name: 'id', description: 'MongoDB ID of the message template' })
  ...
  @ApiOperation({
    ...
    description:
      'Soft-deletes the local template record. The Brevo copy may remain and require manual cleanup.',
  })
  @ApiParam({ name: 'id', description: 'MongoDB ID of the message template' })
  ...
  @ApiOperation({
    ...
    description:
      'Compares local templates with Brevo SMTP templates and syncs in both directions. New remote templates are imported; local changes are pushed.',
  })
  ...
  @ApiOperation({
    ...
    description:
      "Pushes the local template's HTML content and subject to the corresponding Brevo SMTP template.",
  })
  @ApiParam({
    name: 'id',
    description: 'MongoDB ID of the local template to push',
  })
  @ApiResponse({
    status: 201,
    description: 'Template synced to Brevo successfully',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 404, description: 'Template not found' })
  @ApiResponse({ status: 429, description: 'Rate limit exceeded' })
  ...
  @ApiOperation({
    ...
    description:
      'Fetches a template from Brevo by its numeric external ID and creates or updates the corresponding local template.',
  })
  @ApiParam({
    name: 'externalId',
    description: 'Brevo numeric template ID to import from',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Dispatches an email using a pre-configured template slug with dynamic variable substitution. Supports CC, BCC, and custom sender overrides.',
  })
  @ApiResponse({ status: 201, description: 'Template message dispatched' })
  @ApiResponse({
    status: 400,
    description: 'Invalid request body or missing required params',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  ...
  @ApiOperation({
    ...
    description:
      'Registers a new outbound webhook that will receive POST notifications for specified system events.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Returns paginated outbound webhook subscriptions. Filter by active status or search by URL.',
  })
  @ApiQuery({
    name: 'page',
    required: false,
  ...
  @ApiOperation({
    ...
    description:
      'Returns full configuration of a single webhook subscription including subscribed events and secret.',
  })
  @ApiParam({
    name: 'id',
    description: 'MongoDB ID of the webhook subscription',
  })
  ...
  @ApiOperation({
    ...
    description:
      "Partially updates a webhook subscription's URL, events, secret, or active status.",
  })
  @ApiParam({
    name: 'id',
    description: 'MongoDB ID of the webhook subscription',
  ...
  @ApiOperation({
    ...
    description:
      'Soft-deletes the webhook subscription. It will no longer receive event notifications.',
  })
  @ApiParam({
    name: 'id',
    description: 'MongoDB ID of the webhook subscription',
  ...
  @ApiOperation({
    ...
    description:
      'Programmatically registers a public URL with Brevo to receive transactional email event callbacks (delivered, opened, bounced, etc.).',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Removes the previously registered webhook URL from Brevo. Brevo will stop sending event callbacks.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Fetches all verified sender email addresses and names from the connected Brevo account.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new sender email/name pair on Brevo. The sender may need to verify ownership via email before use.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Removes a registered sender from the Brevo account by its numeric Brevo sender ID.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Returns all application events grouped by category, along with their payload registry. Used for building event-template mappings.',
  })
  @ApiResponse({
    status: 200,
    description: 'Categorised system events with payload registry',
  })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 429, description: 'Rate limit exceeded' })
  getSystemEvents() {
  ...
  @ApiOperation({
    ...
    description:
      'Returns all configured event-to-template mappings that define which templates are triggered by which system events.',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Maps a system event to one or more message templates with trigger configuration (recipient path, CC, BCC, sender overrides).',
  })
  ...
  @ApiOperation({
    ...
    description:
      "Partially updates an event mapping's triggers, recipient paths, or active status.",
  })
  @ApiParam({
    name: 'id',
    description: 'MongoDB ID of the event-template mapping',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Soft-deletes the mapping. The system event will no longer trigger communications via this mapping.',
  })
  @ApiParam({
    name: 'id',
    description: 'MongoDB ID of the event-template mapping',
