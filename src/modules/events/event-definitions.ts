...
> = {
  ...
  [AppEvents.SUBSCRIBER_BULK_EMAIL_SENT]: [
    {
      field: 'websiteId',
      type: 'string',
      description: 'Website ID when scoped',
    },
  ...
  [AppEvents.NOMINATION_SUBMITTED]: [
    ...
    {
      field: 'nominatorCompany',
      type: 'string',
      description: 'Nominator Company',
    },
    { field: 'nominatorCity', type: 'string', description: 'Nominator City' },
    {
      field: 'nominatorSnapshot.name',
      type: 'string',
      description: 'Nominator Snapshot Name',
    },
    {
      field: 'nominatorSnapshot.email',
      type: 'string',
      description: 'Nominator Snapshot Email',
    },
    {
      field: 'nominatorSnapshot.company',
      type: 'string',
      description: 'Nominator Snapshot Company',
    },
    {
      field: 'nominatorSnapshot.city',
      type: 'string',
      description: 'Nominator Snapshot City',
    },
    {
      field: 'nominatorSnapshot.phone',
      type: 'string',
      description: 'Nominator Snapshot Phone',
    },
    {
      field: 'nominees',
      type: 'array',
