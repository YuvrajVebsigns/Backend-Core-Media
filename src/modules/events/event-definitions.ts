...
> = {
  ...
  [AppEvents.ATTENDEE_REGISTERED]: [
    ...
    { field: 'registreePhone', type: 'string', description: 'Registree Phone Number' },
    { field: 'registreeOrg', type: 'string', description: 'Registree Organization' },
    ...
    { field: 'eventDescription', type: 'string', description: 'Event Description' },
    { field: 'eventStartDate', type: 'string', description: 'Event Start Date (IST)' },
    { field: 'eventStartTime', type: 'string', description: 'Event Start Time (IST)' },
    { field: 'eventEndDate', type: 'string', description: 'Event End Date (IST)' },
    { field: 'eventEndTime', type: 'string', description: 'Event End Time (IST)' },
    { field: 'eventLocation', type: 'string', description: 'Event Location (Venue, Address, City...)' },
    { field: 'eventMeetingLink', type: 'string', description: 'Event Meeting Link' },
    { field: 'eventBannerImage', type: 'string', description: 'Event Banner Image URL' },
    { field: 'eventSponsorsDetails', type: 'string', description: 'Event Sponsors Details Summary' },
    { field: 'eventAgendaDetails', type: 'string', description: 'Event Agenda Items Details Summary' },
    ...
    { field: 'websiteOgImage', type: 'string', description: 'Website OG Image' },
  ],
  ...
  [AppEvents.BLOG_CREATED]: [
    ...
    { field: 'blogFeatureImage', type: 'string', description: 'Blog Feature Image URL' },
    { field: 'blogPublishedAt', type: 'string', description: 'Blog Published At Date' },
    { field: 'blogAuthorName', type: 'string', description: 'Blog Author Name' },
    { field: 'blogAuthorEmail', type: 'string', description: 'Blog Author Email' },
    { field: 'websiteName', type: 'string', description: 'Website Name' },
    { field: 'websiteDomain', type: 'string', description: 'Website Domain' },
    { field: 'websiteLogo', type: 'string', description: 'Website Logo' },
    { field: 'websiteOgImage', type: 'string', description: 'Website OG Image' },
  ...
  [AppEvents.CONTACT_SUBMITTED]: [
    ...
    { field: 'contactName', type: 'string', description: 'Contact Submitter Full Name' },
    { field: 'contactEmail', type: 'string', description: 'Contact Submitter Email' },
    { field: 'contactPhone', type: 'string', description: 'Contact Submitter Phone' },
    { field: 'contactService', type: 'string', description: 'Contact Service/Topic' },
    { field: 'contactMessage', type: 'string', description: 'Contact Message Body' },
    { field: 'websiteName', type: 'string', description: 'Website Name' },
    { field: 'websiteDomain', type: 'string', description: 'Website Domain' },
    { field: 'websiteLogo', type: 'string', description: 'Website Logo' },
    { field: 'websiteOgImage', type: 'string', description: 'Website OG Image' },
  ...
  [AppEvents.CONTACT_REPLIED]: [
    ...
    { field: 'contactService', type: 'string', description: 'Contact Service/Topic' },
    { field: 'contactMessage', type: 'string', description: 'Contact Message Body' },
    { field: 'contactReplyMessage', type: 'string', description: 'Contact Reply Message' },
    { field: 'contactRepliedAt', type: 'string', description: 'Contact Reply Date' },
    { field: 'contactRepliedByName', type: 'string', description: 'Admin Replied User Name' },
    { field: 'contactRepliedByEmail', type: 'string', description: 'Admin Replied User Email' },
    { field: 'websiteName', type: 'string', description: 'Website Name' },
    { field: 'websiteDomain', type: 'string', description: 'Website Domain' },
    { field: 'websiteLogo', type: 'string', description: 'Website Logo' },
    { field: 'websiteOgImage', type: 'string', description: 'Website OG Image' },
  ...
  [AppEvents.SPONSOR_CREATED]: [
    ...
    { field: 'sponsorDescription', type: 'string', description: 'Sponsor Description' },
  ],
  ...
  [AppEvents.NOMINATION_SUBMITTED]: [
    ...
    { field: 'nominatorOrg', type: 'string', description: 'Nominator Organization' },
    { field: 'nominatorCity', type: 'string', description: 'Nominator City' },
    { field: 'nomineeDetails', type: 'string', description: 'Nominees List Detail Summary' },
    { field: 'nominationStatus', type: 'string', description: 'Nomination Status' },
    { field: 'websiteName', type: 'string', description: 'Website Name' },
    { field: 'websiteDomain', type: 'string', description: 'Website Domain' },
    { field: 'websiteLogo', type: 'string', description: 'Website Logo' },
    { field: 'websiteOgImage', type: 'string', description: 'Website OG Image' },
  ...
  [AppEvents.WEBSITE_CREATED]: [
    ...
    { field: 'websiteDomain', type: 'string', description: 'Website Domain' },
    { field: 'websiteDescription', type: 'string', description: 'Website Description' },
  ...
  [AppEvents.REPORT_CREATED]: [
    ...
    { field: 'reportDescription', type: 'string', description: 'Report Description' },
    { field: 'reportDownloadCount', type: 'number', description: 'Report Download Count' },
    { field: 'websiteName', type: 'string', description: 'Website Name' },
    { field: 'websiteDomain', type: 'string', description: 'Website Domain' },
    { field: 'websiteLogo', type: 'string', description: 'Website Logo' },
    { field: 'websiteOgImage', type: 'string', description: 'Website OG Image' },
